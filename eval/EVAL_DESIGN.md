...
| multi_hop | Arena where Celtics play opened in what year? | 1995 (TD Garden) | `Weights Celtics basketball`, `TD Garden arena opening year Boston` | **TD Garden** opened in **1995** (originally FleetCenter) | 12,876 | 2 | 13.3s | $0.07 | 1.00 | Y | Y |
...
| multi_hop | Arena where Celtics play opened in what year? | 1995 (TD Garden) | `Weights Celtics`, `TD Garden arena opening year` | **TD Garden** opened in **1995** (originally FleetCenter) | 16,393 | 2 | 13.7s | $0.09 | 1.00 | Y | Y | N |
...
| multi_hop | Arena where Celtics play opened in what year? | 1995 (TD Garden) | `Weights Celtics basketball`, `TD Garden opening year` | **TD Garden** opened in **1995** (originally FleetCenter) | 17,519 | 2 | 12.4s | $0.09 | 1.00 | Y | Y | N | Y |
